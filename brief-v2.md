...
Current brief URL: `https://rancmd.github.io/test/brief-v2.md`
...
**Versioning:** Brief files are named `brief-v1.md`, `brief-v2.md` etc. to avoid caching issues.
...
- **Font:** Monospace / retro terminal (VT323 or Share Tech Mono from Google Fonts)
